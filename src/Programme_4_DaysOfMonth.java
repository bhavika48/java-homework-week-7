...
● getDaysInMonth(1, -2020); should return -1 since the parameter year is outside the range of 1to9999*/

import java.time.YearMonth;

public class Programme_4_DaysOfMonth {
    public static boolean isLeapYear(int year) {  //method with parameter
        if (year >= 1 && year <= 9999) {
    ...
    public static void getDaysInMonth(int month, int year) {    //method with parameter
        int daysInMonth;
        if (month < 1 || month > 12) {
